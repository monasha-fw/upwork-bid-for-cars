...
class ValueFailure<T> with _$ValueFailure<T> {
  ...
  const factory ValueFailure.invalidConfirmPassword({required T failedValue}) = InvalidConfirmPassword<T>;
  ...
  const factory ValueFailure.invalidPhoneCountryCode({required T failedValue}) = InvalidPhoneCountryCode<T>;
  ...
  const factory ValueFailure.invalidGoogleIdToken({required T? failedValue}) = InvalidGoogleIdToken<T>;
  ...
  const factory ValueFailure.invalidVerificationToken({required T? failedValue}) = InvalidVerificationToken<T>;

  const factory ValueFailure.invalidVerificationCode({required T? failedValue}) = InvalidVerificationCode<T>;

  const factory ValueFailure.invalidImageUrl({required T? failedValue}) = invalidImageUrl<T>;

  const factory ValueFailure.invalidConversationName({required T? failedValue}) = InvalidConversationName<T>;
  ...
  const factory ValueFailure.invalidMatchingInterests({required T? failedValue}) = InvalidMatchingInterests<T>;

  const factory ValueFailure.invalidReportUserId({required T? failedValue}) = InvalidReportUserId<T>;

  const factory ValueFailure.invalidReportMessage({required T? failedValue}) = InvalidReportMessage<T>;
