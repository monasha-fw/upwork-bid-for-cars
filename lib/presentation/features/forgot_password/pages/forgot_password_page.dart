...
import 'package:bid_for_cars/presentation/features/forgot_password/bloc/forgot_password_cubit.dart';
            ...
            listener: (ctx, state) {
              if (state.result.isSome()) {
                if (state.result.asSome().isRight()) {
                  ...
                  /// and show a success snack
                  context.scaffoldMessenger.showSnack(
                    t.auth.forgotPass.responses.submitSuccess,
